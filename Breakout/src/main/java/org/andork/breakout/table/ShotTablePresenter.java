...
public class ShotTablePresenter extends AbstractTableModel
{
	...
	public ShotTablePresenter( Binder<QObject<NewProjectModel>> projectModelBinder )
	{
		...
		decimalSeparatorBinder = new QObjectPropertyBinder<>( NewProjectModel.decimalSeparator );
	...
	private List<Column<Integer>> getColumns( )
	{
	...
	private class ShotListener implements QObjectList.Listener<Shot>
	{
		...
		{
			fireTableChanged( new TableModelEvent( ShotTablePresenter.this , fromIndex , toIndex ,
	...
	{
		public UncheckedStringColumn( Property<String> valueProperty )
		{
			super( );
	...
	{
		public CheckedStringColumn( Property<String> valueProperty , Property<ParsedText> textProperty )
		{
			super( );
			this.valueProperty = valueProperty;
		...
		Property<String>		valueProperty;
		Property<ParsedText>	textProperty;
	...
	{
		public SubVectorColumn( Property<V> valueProperty , Property<ParsedText> textProperty , Function<V, E> elemFn ,
