...
public enum SurveyColumnType
{
	...
	public Column<QObject<Row>> createCustomColumn( int id )
	{
	...
	public final Map<String, FormatAndDisplayInfo<?>>		availableFormatIdMap;
	...
	private SurveyColumnType( String displayName , Class<?> valueClass , Object prototypeValue , List<FormatAndDisplayInfo<?>> availableFormats )
	{
		...
		this.availableFormatIdMap = new LinkedHashMap<>( );
		for( FormatAndDisplayInfo<?> format : availableFormats )
		{
			this.availableFormatIdMap.put( format.id( ) , format );
		}
	}
