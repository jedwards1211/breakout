...
import org.andork.breakout.BreakoutMainView;
...
{
	/**
	 * the path to the current project file, relative to the current {@linkplain BreakoutMainView#getRootDirectory()
	...
	public static final Attribute<Path>							currentProjectFile					= newAttribute(
																										...
																										"currentProjectFile" );
	/**
	 * the paths to recent project files, relative to the current {@linkplain BreakoutMainView#getRootDirectory()
	 * root settings directory}.
	 */
