...
import static org.andork.breakout.wallsimport.CardinalDirection.EAST;
import static org.andork.breakout.wallsimport.CardinalDirection.NORTH;
import static org.andork.breakout.wallsimport.CardinalDirection.SOUTH;
import static org.andork.breakout.wallsimport.CardinalDirection.WEST;
import static org.andork.breakout.wallsimport.LineTokenizer.SIGN;
import static org.andork.breakout.wallsimport.LineTokenizer.UNSIGNED_FLOATING_POINT;

import java.text.ParseException;
import java.util.regex.Pattern;

import org.andork.breakout.wallsimport.WallsImportMessage.Severity;
...
public class WallsParser
{
	...
	public ValueToken<UnitizedDouble<Length>> pullUnsignedDistance( LineTokenizer lineTokenizer ,
		...
		ParseLogger logger )
	{
		ValueToken<UnitizedDouble<Length>> omitToken = lineTokenizer.pull( LineTokenizer.OMIT , s -> null );
		if( omitToken != null )
		{
			return omitToken;
		}
		...
		ParseLogger logger )
	{
		...
		if( abs == null )
		{
			if( negate )
			{
				...
				Token dashes = lineTokenizer.pull( LineTokenizer.OMIT );
	...
	public ValueToken<UnitizedDouble<Angle>> pullAzimuth( LineTokenizer lineTokenizer , Unit<Angle> defaultUnit ,
		ParseLogger logger )
	{
		ValueToken<UnitizedDouble<Angle>> omitToken = lineTokenizer.pull( LineTokenizer.OMIT , s -> null );
		if( omitToken != null )
		{
			return omitToken;
		}
