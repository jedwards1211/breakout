...
public class ExportProjectArchiveAction extends AbstractAction {
	 ...
	 *
	 */
	private static final long serialVersionUID = 4241238645505381378L;
		...
		new OnEDT() {
			...
			public void run() throws Throwable {
				...
				projectFileChooser.addChoosableFileFilter(new FileNameExtensionFilter(
						"Breakout Project Archive File (*.boa)", "boa"));
			}
		};
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		mainView.getRootModel().set(RootModel.currentArchiveFileChooserDirectory,
