...
public class Vecmath {
	...
	public static void lookAt(double[] mat, double eyex, double eyey, double eyez, double centerx, double centery,
		...
		invMag = 1f / Math.sqrt(forwardx * forwardx + forwardy * forwardy + forwardz * forwardz);
		forwardx = forwardx * invMag;
		forwardy = forwardy * invMag;
		forwardz = forwardz * invMag;

		invMag = 1f / Math.sqrt(upx * upx + upy * upy + upz * upz);
		upx *= invMag;
		upy *= invMag;
		upz *= invMag;
		...
		invMag = 1f / Math.sqrt(sidex * sidex + sidey * sidey + sidez * sidez);
		sidex *= invMag;
		sidey *= invMag;
		sidez *= invMag;
	...
	public static void perspective(double[] mat, double fovx, double aspect,
		...
		mat[11] = -1f;
		mat[4] = mat[8] = mat[12] = mat[1] = mat[9] = mat[13] = mat[2] = mat[6] = mat[3] = mat[7] = mat[15] = 0;
	}
