...
/**
 * Represents a planar hull and provides methods to test if it contains or
 * intersects bounding boxes and points. For view volume hulls, there are
 * canonical orders and properties:<br>
 * <br>
 ...
 * </pre>
 *
 * <b>triangleIndices / triangleSides</b> (use
 * {@link #setCanonicalTriangleIndicesAndPlanes()}):
 *
 * <pre>
 * [0] { 0, 6, 4 } / 0
 * [1] { 6, 0, 2 } / 0
 ...
 * </pre>
 *
 * The triangle planes should always be in ascending order, and the triangle
 * indices should always be in counterclockwise order when viewed from outside
 * the hull (in case the hull needs to be rendered for debugging purposes).
 *
 * @author Andy
 */
