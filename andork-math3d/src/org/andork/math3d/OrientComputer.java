...
public class OrientComputer {
	 ...
	 *            <code>newX</code>).
	 * @param result
	 *            the double[] to set such that (ignoring floating point
	 *            inaccuracy):
	 *            <ul>
	 ...
	 *
	 * @see #orient(double[], double[], double[], double[], double[], double[],
	 *      double[])
	 */
	 ...
	 *             </ul>
	 */
	public double[] orient(double[] oldOrigin, double[] oldX, double[] oldY, double[] newOrigin, double[] newX,
			double[] newY, double[] result) {
	 ...
	 *      double[])
	 */
	public double[] orientInPlace(double oldAxisX, double oldAxisY, double oldAxisZ, double[] newAxis,
			double[] result) {
	 ...
	 *      double[])
	 */
	public double[] orientInPlace(double[] oldAxis, double newAxisX, double newAxisY, double newAxisZ,
			double[] result) {
	 ...
	 *
	 * @see #shear(double[], double[], double[], double[], double[], double[],
	 ...
	 *            inaccuracy):
	 *            <ul>
	 *            <li><code>result.transform( new double[]{ 0, 0, 0 } )</code>
	 *            equals <code>newOrigin</code>,</li>
	 *            <li><code>result.transform( new double[]{ 1, 0, 0 } )</code>
	 *            equals <code>newX</code>,</li>
	 *            <li><code>result.transform( new double[]{ 0, 1, 0 } )</code>
	 *            equals <code>newY</code>, and</li>
	 *            <li><code>result.transform( new double[]{ 0, 0, 1 } )</code>
	 ...
	 *             is zero
	 */
	public double[] shear(double[] oldOrigin, double[] oldX, double[] oldY, double[] oldZ, double[] newOrigin,
			double[] newX, double[] newY, double[] newZ, double[] result) {
		if (oldX.equals(ZERO) || oldY.equals(ZERO) || oldZ.equals(ZERO) || newX.equals(ZERO) || newY.equals(ZERO)
				|| newZ.equals(ZERO)) {
