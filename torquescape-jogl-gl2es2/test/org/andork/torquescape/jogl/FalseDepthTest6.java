...
import org.andork.torquescape.model.track.Track2;
...
public class FalseDepthTest6 extends TorquescapeSetup
{
	public static void main( String[ ] args )
	{
		FalseDepthTest6 test = new FalseDepthTest6( );
	...
	protected TorquescapeScene createScene( )
	{
		...
		Zone zone = createZone( new Track2( ) , sequence( 0 , ( float ) Math.PI * 4 , ( float ) Math.PI / 360f ) );
		...
		obj.add( new Uniform1fv( ).name( "u_v_period" ).value( 10f ) );
		obj.transpose( false );
