...
public class FalseDepthTest5d extends TorquescapeSetup
{
	public static void main( String[ ] args )
	{
		FalseDepthTest5d test = new FalseDepthTest5d( );
	...
	public static class MatrixFragmentShader2
	{
		...
		public String toString( )
		{
			...
			sb.append( "    float intensity = min(pow(abs(cu), 2.0), pow(abs(cv), 10.0));" );
