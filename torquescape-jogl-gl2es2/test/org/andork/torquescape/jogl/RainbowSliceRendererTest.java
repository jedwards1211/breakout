...
public class RainbowSliceRendererTest extends BasicJOGLSetup
{
	public static void main( String[ ] args )
	{
		RainbowSliceRendererTest test = new RainbowSliceRendererTest( );
		test.glWindow.setTitle( "Rainbow Slice Renderer" );
	...
	{
		BasicJOGLScene result = new BasicJOGLScene( )
		{
	...
	private void init( BasicJOGLScene scene )
	{
