...
public class FalseDepthTest2 extends TorquescapeSetup
{
	public static void main( String[ ] args )
	{
		FalseDepthTest2 test = new FalseDepthTest2( );
	...
	protected TorquescapeScene createScene( )
	{
		...
		obj.add( obj.new Uniform1fv( ).name( "u_layer_depths" ).count( 5 ).value( 0 , 0.1f , 0.2f ) );
		obj.add( obj.new Uniform4fv( ).name( "u_layer_colors" ).count( 5 ).value(
				...
				0.75f , 0.25f , 0 , 1 ,
				0.5f , 0.5f , 0f , 1 ) );
		obj.add( obj.new Uniform1fv( ).name( "u_u_period" ).value( 20f ) );
