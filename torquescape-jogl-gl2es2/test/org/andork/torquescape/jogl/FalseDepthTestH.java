...
public class FalseDepthTestH extends BasicJOGLSetup
{
	public static void main( String[ ] args )
	{
		FalseDepthTestH test = new FalseDepthTestH( );
	...
	{
		BasicJOGLScene scene = super.createScene( );
		...
		obj.add( obj.new Uniform1fv( ).name( "u_layer_depths" ).count( 5 ).value( 0 , 2f , 4f ) );
