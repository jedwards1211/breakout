...
import org.andork.torquescape.model.track.Track3;
...
public class FalseDepthTest7 extends TorquescapeSetup
{
	public static void main( String[ ] args )
	{
		FalseDepthTest7 test = new FalseDepthTest7( );
	...
	protected TorquescapeScene createScene( )
	{
		...
		Zone zone = createZone( new Track3( ) , sequence( 0 , ( float ) Math.PI * 4 , ( float ) Math.PI / 360f ) );
		...
		obj.add( obj.new Uniform1fv( ).name( "u_v_period" ).value( 3f ) );
		obj.transpose( true );
