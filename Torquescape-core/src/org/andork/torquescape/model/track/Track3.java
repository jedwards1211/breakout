...
import static org.andork.torquescape.model.coord.CoordUtils.generateSmoothPolygon;
...
public class Track3 extends Track
{
	public Track3( )
	{
		init( );
	...
	private void init( )
	{
		...
		ICoordFn section = new FixedCoordFn( reverse3( generateSmoothPolygon( points , 5 ) ) );
		...
		{
			meshing[ k++ ] = ( char ) ( ( i ) % ( points ) );
			meshing[ k++ ] = ( char ) ( ( i + 1 ) % ( points ) );
			meshing[ k++ ] = ( char ) ( ( i ) % ( points ) + points );
			meshing[ k++ ] = ( char ) ( ( i + 1 ) % ( points ) + points );
			meshing[ k++ ] = ( char ) ( ( i ) % ( points ) + points );
			meshing[ k++ ] = ( char ) ( ( i + 1 ) % ( points ) );
		}
