...
public class GridBagWizard
{
	...
	{
		this.target = target;
		this.layout = ( GridBagLayout ) target.getLayout( );
	}
	...
	/**
	 * Creates a {@code GridBagWizard} for adding components to the given target {@link Container}. If the container's layout is not a {@link GridBagLayout}, it
	 * will be replaced with a new {@link GridBagLayout}, and all previous layout information will be lost.
	 * 
	 * @param target
	 *            the container to create a {@code GridBagWizard} for.
	 * @return a new {@code GridBagWizard} that {@link #put(Component) adds} components to {@code target}.
	 */
	...
	/**
	 * Adds the given {@link Component} to the target {@link Container} with the {@link #defaults() default constraints}.
	 * 
	 * @param comp
	...
	/**
	 * Adds the given {@link Component Components} and/or {@link IConstrainer IConstrainers} to the target {@link Container} with the {@link #defaults() default
	 * constraints}. Allows you to set {@link GridBagConstraints} for all of them at once using the returned {@link Group}.
	 * 
	 * @param items
	...
	/**
	 * Gets the {@link GridBagConstraints#gridx gridx} set for a given component or {@link IConstrainer}.
	 * 
	 * @param obj
	 *            the component or {@link IConstrainer} to get the {@code gridx} of.
	...
	/**
	 * Gets the leftmost column occupied by the given components and/or {@link IConstrainer}s.
	 * 
	 * @param objs
	...
	/**
	 * Gets the rightmost column occupied by the given components and/or {@link IConstrainer}s.
	 * 
	 * @param objs
	 *            the components and/or {@link IConstrainer}s
	 */
	...
	/**
	 * Gets the {@link GridBagConstraints#gridy gridy} set for a given component or {@link IConstrainer}.
	 * 
	 * @param obj
	 *            the component or {@link IConstrainer} to get the {@code gridy} of.
	...
	/**
	 * Gets the topmost row occupied by the given components and/or {@link IConstrainer}s.
	 * 
	 * @param objs
	 *            the components and/or {@link IConstrainer}s
	 */
	...
	/**
	 * Gets the bottommost row occupied by the given components and/or {@link IConstrainer}s.
	 * 
	 * @param objs
	 *            the components and/or {@link IConstrainer}s
	 */
	...
	/**
	 * Gets the {@link GridBagConstraints#gridwidth gridwidth} set for a given component or {@link IConstrainer}.
	 * 
	 * @param obj
	 *            the component or {@link IConstrainer} to get the {@code gridwidth} of.
	...
	/**
	 * Gets the number of columns spanned by the given components and/or {@link IConstrainer}s.
	 * 
	 * @param objs
	 *            the components and/or {@link IConstrainer}s to get the width of.
	 * @return the number of columns spanned by the given components and/or {@link IConstrainer}s.
	 */
	...
	/**
	 * Gets the {@link GridBagConstraints#gridheight gridheight} set for a given component or {@link IConstrainer}.
	 * 
	 * @param obj
	 *            the component or {@link IConstrainer} to get the {@code gridheight} of.
	 * @return the {@code gridheight} of {@code obj}'s {@link GridBagConstraints}
	 */
	...
	/**
	 * Gets the number of rows spanned by the given components and/or {@link IConstrainer}s.
	 * 
	 * @param objs
	 *            the components and/or {@link IConstrainer}s to get the width of.
	 * @return the number of rows spanned by the given components and/or {@link IConstrainer}s.
	 */
	...
	/**
	 * Gets the {@link GridBagConstraints#anchor anchor} set for a given component or {@link IConstrainer}.
	 * 
	 * @param obj
	 *            the component or {@link IConstrainer} to get the {@code anchor} of.
	...
	/**
	 * Gets the {@link GridBagConstraints#fill fill} set for a given component or {@link IConstrainer}.
	 * 
	 * @param obj
	 *            the component or {@link IConstrainer} to get the {@code fill} of.
	...
	/**
	 * Gets the {@link GridBagConstraints#weightx weightx} set for a given component or {@link IConstrainer}.
	 * 
	 * @param obj
	 *            the component or {@link IConstrainer} to get the {@code weightx} of.
	...
	public double weightx( Object obj )
	{
		...
		else if( obj instanceof Group )
		{
			...
			for( IConstrainer constrainer : g.constrainers )
			{
				...
				{
					throw new IllegalArgumentException( "weightx is ambiguous; Group members have various weightx values" );
				}
			}
		}
		throw new IllegalArgumentException( "obj must be a Component or IConstrainer" );
	...
	/**
	 * Gets the {@link GridBagConstraints#weighty weighty} set for a given component or {@link IConstrainer}.
	 * 
	 * @param obj
	 *            the component or {@link IConstrainer} to get the {@code weighty} of.
	...
	public double weighty( Object obj )
	{
		...
		else if( obj instanceof Group )
		{
			...
			for( IConstrainer constrainer : g.constrainers )
			{
				...
				{
					throw new IllegalArgumentException( "weighty is ambiguous; Group members have various weighty values" );
				}
			}
		}
		throw new IllegalArgumentException( "obj must be a Component or IConstrainer" );
	...
	/**
	 * Gets the {@link GridBagConstraints#ipadx ipadx} set for a given component or {@link IConstrainer}.
	 * 
	 * @param obj
	 *            the component or {@link IConstrainer} to get the {@code ipadx} of.
	...
	/**
	 * Gets the {@link GridBagConstraints#ipady ipady} set for a given component or {@link IConstrainer}.
	 * 
	 * @param obj
	 *            the component {@link IConstrainer} to get the {@code ipady} of.
	...
	/**
	 * Gets the {@link GridBagConstraints#insets insets} set for a given component or {@link IConstrainer}.
	 * 
	 * @param obj
	 *            the component {@link IConstrainer} to get the {@code insets} of.
	...
	/**
	 * Gets the {@link AutoInsets} set for a given component or {@link IConstrainer}.
	 * 
	 * @param obj
	 *            the component or {@link IConstrainer} to get the {@code AutoInsets} of.
	...
	/**
	 * Automatically sets the insets of a component's constraints whenever the component's {@link GridBagConstraints#gridx gridx} or
	...
	/**
	 * An {@link AutoInsets} with fixed column and row spacing. It will only apply insets between columns and rows, so components will touch the top, left,
	 * bottom, and right edges of the target container; use an {@link EmptyBorder} if necessary on the target container.
	 * 
	 * @author andy.edwards
	 */
	...
	public interface IConstrainer
	{
		...
		/**
		 * Sets the {@link GridBagConstraints#gridx gridx} of the target {@link Component}(s).
		 * 
		 * @param x
		...
		/**
		 * Sets the {@link GridBagConstraints#gridx gridx} of the target {@link Component}(s) to the same value as another component's {@code gridx}.
		 * 
		 * @param comp
		...
		/**
		 * Sets the {@link GridBagConstraints#gridx gridx} of the target {@link Component}(s) to the same value as the last
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components}' {@code gridx}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#gridy gridy} of the target {@link Component}(s).
		 * 
		 * @param y
		...
		/**
		 * Sets the {@link GridBagConstraints#gridy gridy} of the target {@link Component}(s) to the same value as the last
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components}' {@code gridy}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#gridx gridx} and {@link GridBagConstraints#gridy gridy} of the target {@link Component}(s).
		 * 
		 * @param x
		 *            the new value for {@code gridx}.
		 * @param y
		...
		/**
		 * Places the target component right of the rightmost component: sets the target component's {@link GridBagConstraints#gridx gridx} so that it is
		 * directly right of the rightmost component (accounting for {@link GridBagConstraints#gridwidth gridwidth}).
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Places the target component below the bottommost component: sets the target component's {@link GridBagConstraints#gridy gridy} so that it is directly
		 * below the bottommost component (accounting for {@link GridBagConstraints#gridheight gridheight}).
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Places the target component above the given component: sets the target component's {@link GridBagConstraints#gridy gridy} so that it is directly
		 * above the given component (accounting for {@link GridBagConstraints#gridheight gridheight}), and if the target component's
		 * {@link GridBagConstraints#gridx gridx} has not been set, sets it to the same value as for the given component. If the target component's
		 * {@code gridheight} is {@link GridBagConstraints#REMAINDER REMAINDER}, the result is undefined.
		 * 
		 * @param comp
		 ...
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components}: sets the target component's
		 * {@link GridBagConstraints#gridy gridy} so that it is directly above the given component (accounting for {@link GridBagConstraints#gridheight
		 * gridheight}), and if the target component's {@link GridBagConstraints#gridx gridx} has not been set, sets it to the same value as for the given
		 * component. If the target component's {@code gridheight} is {@link GridBagConstraints#REMAINDER REMAINDER}, the result is undefined.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Places the target component below the given component: sets the target component's {@link GridBagConstraints#gridy gridy} so that it is directly
		 * below the given component (accounting for {@link GridBagConstraints#gridheight gridheight}), and if the target component's
		 * {@link GridBagConstraints#gridx gridx} has not been set, sets it to the same value as for the given component. If the given component's
		 * {@code gridheight} is {@link GridBagConstraints#REMAINDER REMAINDER}, the result is undefined.
		 * 
		 * @param comp
		 ...
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components}: sets the target component's
		 * {@link GridBagConstraints#gridy gridy} so that it is directly below the given component (accounting for {@link GridBagConstraints#gridheight
		 * gridheight}), and if the target component's {@link GridBagConstraints#gridx gridx} has not been set, sets it to the same value as for the given
		 * component. If the given component's {@code gridheight} is {@link GridBagConstraints#REMAINDER REMAINDER}, the result is undefined.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Places the target component left of the given component: sets the target component's {@link GridBagConstraints#gridx gridx} so that it is directly
		 * left of the given component (accounting for {@link GridBagConstraints#gridwidth gridwidth}), and if the target component's
		 * {@link GridBagConstraints#gridy gridy} has not been set, sets it to the same value as for the given component. If the target component's
		 * {@code gridwidth} is {@link GridBagConstraints#REMAINDER REMAINDER}, the result is undefined.
		 * 
		 * @param comp
		 ...
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components}: sets the target component's
		 * {@link GridBagConstraints#gridx gridx} so that it is directly left of the given component (accounting for {@link GridBagConstraints#gridwidth
		 * gridwidth}), and if the target component's {@link GridBagConstraints#gridy gridy} has not been set, sets it to the same value as for the given
		 * component. If the target component's {@code gridwidth} is {@link GridBagConstraints#REMAINDER REMAINDER}, the result is undefined.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Places the target component right of the given component: sets the target component's {@link GridBagConstraints#gridx gridx} so that it is directly
		 * right of the given component (accounting for {@link GridBagConstraints#gridwidth gridwidth}), and if the target component's
		 * {@link GridBagConstraints#gridy gridy} has not been set, sets it to the same value as for the given component. If the given component's
		 * {@code gridwidth} is {@link GridBagConstraints#REMAINDER REMAINDER}, the result is undefined.
		 * 
		 * @param comp
		 ...
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components}: sets the target component's
		 * {@link GridBagConstraints#gridx gridx} so that it is directly right of the given component (accounting for {@link GridBagConstraints#gridwidth
		 * gridwidth}), and if the target component's {@link GridBagConstraints#gridy gridy} has not been set, sets it to the same value as for the given
		 * component. If the given component's {@code gridwidth} is {@link GridBagConstraints#REMAINDER REMAINDER}, the result is undefined.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Right-aligns the target component with the given component: sets the target component's {@link GridBagConstraints#gridx gridx} so that both
		 * components occupy the same rightmost column (accounting for {@link GridBagConstraints#gridwidth gridwidth}).
		 * 
		 * @param comp
		 *            the component to align the target component to the right of.
		 * @return this {@link IConstrainer}, for chaining.
		 */
		 ...
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components}: sets the target component's
		 * {@link GridBagConstraints#gridx gridx} so that both components occupy the same rightmost column (accounting for {@link GridBagConstraints#gridwidth
		 * gridwidth} ).
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Bottom-aligns the target component with the given component: sets the target component's {@link GridBagConstraints#gridy gridy} so that both
		 * components occupy the same bottommost column (accounting for {@link GridBagConstraints#gridheight gridheight}).
		 * 
		 * @param comp
		 *            the component to align the target component to the bottom of.
		 * @return this {@link IConstrainer}, for chaining.
		 */
		 ...
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components}: sets the target component's
		 * {@link GridBagConstraints#gridy gridy} so that both components occupy the same bottommost column (accounting for
		...
		/**
		 * Sets the {@link GridBagConstraints#gridwidth gridwidth} of the target {@link Component}(s).
		 * 
		 * @param width
		...
		/**
		 * Sets the {@link GridBagConstraints#gridwidth gridwidth} of the target {@link Component}(s) to the same value as the given component has.
		 * 
		 * @param comp
		 *            the {@link Component}(s) to get the {@code gridwidth} from.
		 * @return this {@link IConstrainer}, for chaining.
		 */
		public abstract IConstrainer sameWidth( Object obj );
		
		/**
		 * Sets the {@link GridBagConstraints#gridwidth gridwidth} of the target {@link Component}(s) to the same value as the last
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components} has.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#gridwidth gridwidth} of the target {@link Component}(s) to {@link GridBagConstraints#REMAINDER REMAINDER}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#gridheight gridheight} of the target {@link Component}(s).
		 * 
		 * @param height
		...
		/**
		 * Sets the {@link GridBagConstraints#gridheight gridheight} of the target {@link Component}(s) to the same value as the given component has.
		 * 
		 * @param comp
		 *            the {@link Component}(s) to get the {@code gridheight} from.
		 * @return this {@link IConstrainer}, for chaining.
		 */
		public abstract IConstrainer sameHeight( Object obj );
		
		/**
		 * Sets the {@link GridBagConstraints#gridheight gridheight} of the target {@link Component}(s) to the same value as the last
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components} has.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		...
		/**
		 * Sets the {@link GridBagConstraints#gridheight gridheight} of the target {@link Component}(s) to {@link GridBagConstraints#REMAINDER REMAINDER}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Increases the {@link GridBagConstraints#gridwidth gridwidth} and decreases the {@link GridBagConstraints#gridx gridx} of the target {@link Component}
		 * (s) to by the given number of columns.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Increases the {@link GridBagConstraints#gridwidth gridwidth} of the target {@link Component}(s) to by the given number of columns.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Increases the {@link GridBagConstraints#gridheight gridheight} and decreases the {@link GridBagConstraints#gridy gridy} of the target
		...
		/**
		 * Increases the {@link GridBagConstraints#gridheight gridheight} of the target {@link Component}(s) to by the given number of rows.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Decreases the {@link GridBagConstraints#gridwidth gridwidth} of the target {@link Component}(s) to by the given number of columns.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Decreases the {@link GridBagConstraints#gridwidth gridwidth} and increases the {@link GridBagConstraints#gridx gridx} of the target {@link Component}
		 * (s) to by the given number of columns.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Decreases the {@link GridBagConstraints#gridheight gridheight} of the target {@link Component}(s) to by the given number of rows.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Decreases the {@link GridBagConstraints#gridheight gridheight} and increases the {@link GridBagConstraints#gridy gridy} of the target
		 * {@link Component}(s) to by the given number of rows.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#weightx weightx} of the target {@link Component}(s).
		 * 
		 * @param weightx
		...
		/**
		 * Sets the {@link GridBagConstraints#weightx weightx} of the target {@link Component}(s) to the same value as the given component has.
		 * 
		 * @param comp
		...
		/**
		 * Sets the {@link GridBagConstraints#weightx weightx} of the target {@link Component}(s) to the same value as the last
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components} has.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		...
		/**
		 * Sets the {@link GridBagConstraints#weighty weighty} of the target {@link Component}(s).
		 * 
		 * @param weighty
		...
		/**
		 * Sets the {@link GridBagConstraints#weighty weighty} of the target {@link Component}(s) to the same value as the given component has.
		 * 
		 * @param comp
		...
		/**
		 * Sets the {@link GridBagConstraints#weighty weighty} of the target {@link Component}(s) to the same value as the last
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components} has.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		...
		/**
		 * Sets the {@link GridBagConstraints#weighty weightx} and {@link GridBagConstraints#weighty weighty} of the target {@link Component}(s).
		 * 
		 * @param weightx
		 *            the new value for {@code weightx}.
		 * @param weighty
		...
		/**
		 * Sets the {@link GridBagConstraints#weighty weightx} and {@link GridBagConstraints#weighty weighty} of the target {@link Component}(s) to the same
		 * value as the given component has.
		 * 
		 * @param comp
		 *            the {@link Component}(s) to get the {@code weightx} and {@code weighty} from.
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#anchor anchor} of the target {@link Component}(s).
		 * 
		 * @param anchor
		...
		/**
		 * Sets the {@link GridBagConstraints#anchor anchor} of the target {@link Component}(s) to the same value as the given component has.
		 * 
		 * @param comp
		...
		/**
		 * Sets the {@link GridBagConstraints#anchor anchor} of the target {@link Component}(s) to the same value as the last
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components} has.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		...
		/**
		 * Sets the {@link GridBagConstraints#anchor anchor} of the target {@link Component}(s) to {@link GridBagConstraints#NORTH NORTH}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#anchor anchor} of the target {@link Component}(s) to {@link GridBagConstraints#NORTHEAST NORTHEAST}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#anchor anchor} of the target {@link Component}(s) to {@link GridBagConstraints#EAST EAST}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#anchor anchor} of the target {@link Component}(s) to {@link GridBagConstraints#SOUTHEAST SOUTHEAST}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#anchor anchor} of the target {@link Component}(s) to {@link GridBagConstraints#SOUTH SOUTH}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#anchor anchor} of the target {@link Component}(s) to {@link GridBagConstraints#SOUTHWEST SOUTHWEST}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#anchor anchor} of the target {@link Component}(s) to {@link GridBagConstraints#WEST WEST}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#anchor anchor} of the target {@link Component}(s) to {@link GridBagConstraints#NORTHWEST NORTHWEST}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#fill fill} of the target {@link Component}(s) to {@link GridBagConstraints#HORIZONTAL HORIZONTAL} .
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#fill fill} of the target {@link Component}(s) to {@link GridBagConstraints#HORIZONTAL HORIZONTAL} and sets the
		...
		/**
		 * Sets the {@link GridBagConstraints#fill fill} of the target {@link Component}(s) to {@link GridBagConstraints#VERTICAL VERTICAL}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#fill fill} of the target {@link Component}(s) to {@link GridBagConstraints#VERTICAL VERTICAL} and sets the
		...
		/**
		 * Sets the {@link GridBagConstraints#fill fill} of the target {@link Component}(s).
		 * 
		 * @param fill
		...
		/**
		 * Sets the {@link GridBagConstraints#fill fill} of the target {@link Component}(s) to {@link GridBagConstraints#NONE NONE}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#fill fill} of the target {@link Component}(s) to {@link GridBagConstraints#BOTH BOTH}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#fill fill} of the target {@link Component}(s) to {@link GridBagConstraints#BOTH BOTH} and sets the
		 * {@link GridBagConstraints#weightx} and {@link GridBagConstraints#weighty}.
		 * 
		 * @param weightx
		 *            the new value for {@code weightx}.
		 * @param weighty
		...
		/**
		 * Sets the {@link GridBagConstraints#fill fill} of the target {@link Component}(s) to the same value as the given component has.
		 * 
		 * @param comp
		...
		/**
		 * Sets the {@link GridBagConstraints#fill fill} of the target {@link Component}(s) to the same value as the last
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components} has.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		...
		/**
		 * Sets the {@link GridBagConstraints#ipadx ipadx} of the target {@link Component}(s).
		 * 
		 * @param ipadx
		...
		/**
		 * Sets the {@link GridBagConstraints#ipadx ipadx} of the target {@link Component}(s) to the same value as the given component has.
		 * 
		 * @param comp
		...
		/**
		 * Sets the {@link GridBagConstraints#ipadx ipadx} of the target {@link Component}(s) to the same value as the last
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components} has.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		...
		/**
		 * Sets the {@link GridBagConstraints#ipady ipady} of the target {@link Component}(s).
		 * 
		 * @param ipady
		...
		/**
		 * Sets the {@link GridBagConstraints#ipady ipady} of the target {@link Component}(s) to the same value as the given component has.
		 * 
		 * @param comp
		...
		/**
		 * Sets the {@link GridBagConstraints#ipady ipady} of the target {@link Component}(s) to the same value as the last
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components} has.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		...
		/**
		 * Sets the {@link GridBagConstraints#ipady ipadx} and {@link GridBagConstraints#ipady ipady} of the target {@link Component}(s).
		 * 
		 * @param ipadx
		 *            the new value for {@code ipadx}.
		 * @param ipady
		...
		/**
		 * Sets the {@link GridBagConstraints#ipady ipadx} and {@link GridBagConstraints#ipady ipady} of the target {@link Component}(s) to the same value as
		 * the given component has.
		 * 
		 * @param comp
		 *            the {@link Component}(s) to get the {@code ipadx} and {@code ipady} from.
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#insets insets} of the target {@link Component}(s).
		 * 
		 * @param insets
		...
		/**
		 * Adds to the {@link GridBagConstraints#insets insets} of the target {@link Component}(s).
		 * 
		 * @param top
		...
		/**
		 * Sets the {@link GridBagConstraints#insets insets} of the target {@link Component}(s) to the same value as the given component has.
		 * 
		 * @param comp
		...
		/**
		 * Sets the {@link GridBagConstraints#insets insets} of the target {@link Component}(s) to the same value as the last
		 * 
		 * {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...) components} has.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		...
		/**
		 * Sets the {@link GridBagConstraints#insets insets} automatically, based on the {@link #autoinsets()}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 */
		...
		/**
		 * Sets the {@link AutoInsets}. If non-{@code null}, it will automatically set the {@link GridBagConstraints#insets insets} now and whenever
		 * {@link GridBagConstraints#gridx gridx} or {@link GridBagConstraints#gridy gridy} is changed via a {@link Constrainer} method.
		 * 
		 * @param autoinsets
		...
		/**
		 * Sets the {@link AutoInsets} to the same as the last {@link GridBagWizard#put(Component) added} component or {@link GridBagWizard#put(Object...)
		 * components}.
		 * 
		 * @return this {@link IConstrainer}, for chaining.
		 * @see #autoinsets(AutoInsets)
		...
		/**
		 * Sets the {@link #autoinsets() autoinsets} to a {@link DefaultAutoInsets} with the given spacings.
		 * 
		 * @param xspacing
	...
	/**
	 * Allows you to set {@link GridBagConstraints} in builder-like fashion, with many convenience methods.
	 * 
	 * @author andy.edwards
	 */
	public class Constrainer implements IConstrainer
	{
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameX(java.awt.Component )
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameY(java.awt.Component )
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#above(java.awt.Component )
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#gridx gridx} of the target {@link Component} so that it is above all the {@link Component}s, {@link Constrainer}s,
		 * and or {@link Group}s in {@code objs}. If the {@link GridBagConstraints#gridwidth gridwidth} for the target component has not been set yet, it will
		 * be set so that the target component spans all of the columns they occupy.
		 * 
		 * @param objs
		 *            the {@link Component}s, {@link Constrainer}s, and/or {@link Group}s to place the target component above.
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#below(java.awt.Component )
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#gridx gridx} of the target {@link Component} so that it is below all the {@link Component}s, {@link Constrainer}s,
		 * and or {@link Group}s in {@code objs}. If the {@link GridBagConstraints#gridwidth gridwidth} for the target component has not been set yet, it will
		 * be set so that the target component spans all of the columns they occupy.
		 * 
		 * @param objs
		 *            the {@link Component}s, {@link Constrainer}s, and/or {@link Group}s to place the target component below.
		 * @return this {@link Constrainer}, for chaining.
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#leftOf(java.awt.Component )
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#gridy gridy} of the target {@link Component} so that it is left of all the {@link Component}s, {@link Constrainer}
		 * s, and or {@link Group}s in {@code objs}. If the {@link GridBagConstraints#gridheight gridheight} for the target component has not been set yet, it
		 * will be set so that the target component spans all of the rows they occupy.
		 * 
		 * @param objs
		 *            the {@link Component}s, {@link Constrainer}s, and/or {@link Group}s to place the target component left of.
		 * @return this {@link Constrainer}, for chaining.
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#rightOf(java.awt.Component )
		 */
		...
		/**
		 * Sets the {@link GridBagConstraints#gridy gridy} of the target {@link Component} so that it is right of all the {@link Component}s,
		 * {@link Constrainer}s, and or {@link Group}s in {@code objs}. If the {@link GridBagConstraints#gridheight gridheight} for the target component has not
		 * been set yet, it will be set so that the target component spans all of the rows they occupy.
		 * 
		 * @param objs
		 *            the {@link Component}s, {@link Constrainer}s, and/or {@link Group}s to place the target component right of.
		 * @return this {@link Constrainer}, for chaining.
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#alignRight(java.awt. Component)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#alignBottom(java.awt .Component)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameWidth(java.awt.Component )
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameHeight(java.awt. Component)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameWeightx(java.awt .Component)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameWeighty(java.awt .Component)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#weight(double, double)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameWeight(java.awt. Component)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameAnchor(java.awt. Component)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#fillboth(double, double)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameFill(java.awt.Component )
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameIpadx(java.awt.Component )
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameIpady(java.awt.Component )
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameIpad(java.awt.Component )
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#insets(java.awt.Insets)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#insets(int, int, int, int)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#addToInsets(int, int, int, int)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#sameInsets(java.awt. Component)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#autoinsets(com.cybertrader .streamer.common.GridBagWizard.AutoInsets)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#autoinsets(java.awt. Component)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cybertrader.streamer.common.IConstrainer#defaultAutoinsets(int, int)
		 */
	...
	public class Group implements IConstrainer
	{
		...
		private void ensureYset( IConstrainer constrainer )
		{
			...
			{
				ensureYset( ( Group ) constrainer );
			}
		}
		
		/**
		 * Uses {@link Constrainer#rightOf(Component)} to arrange the components in a row.
		 */
		...
		/**
		 * Uses {@link Constrainer#below(Component)} to arrange the components in a column.
		 */
