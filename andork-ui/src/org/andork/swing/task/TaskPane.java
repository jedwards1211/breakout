...
import org.andork.task.NewTask;
...
public class TaskPane extends JPanel {
	...
	protected void modelToView() {
		...
		double progress = task.getCombinedProgress();
		progressBar.setIndeterminate(task == null ? true : !Double.isFinite(progress));
		progressBar.setMaximum(task == null ? 0 : 100000);
