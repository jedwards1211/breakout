 ...
 * <ul>
 * <li>It will invoke {@link AnnotatingTableCellRenderer}s with annotations from
 * an {@link AnnotatingRowSorter} if one is installed.
 * </ul>
 *
 * @author Andy
 */
...
public class AnnotatingJTable extends BetterJTable {
	 ...
	 *
	 */
	private static final long serialVersionUID = 3417009628507224252L;
	...
	public Component prepareRenderer(TableCellRenderer renderer, int row, int column) {
		...
		// this isn't nice but it's the only way I can figure out to reset the
	...
	public void setModel(TableModel dataModel) {
		...
		AnnotatingRowSorter rowSorter = getAnnotatingRowSorter();
		if (rowSorter != null) {
