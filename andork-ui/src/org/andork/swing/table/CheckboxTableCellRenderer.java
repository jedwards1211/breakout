...
public class CheckboxTableCellRenderer extends DefaultTableCellRenderer implements TableCellRenderer {
	 ...
	 *
	 */
	private static final long serialVersionUID = 8790583685723214364L;
	JCheckBox checkBox;
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
			int row, int column) {
		JComponent superRenderer = (JComponent) super.getTableCellRendererComponent(table, value, isSelected, hasFocus,
				row, column);
