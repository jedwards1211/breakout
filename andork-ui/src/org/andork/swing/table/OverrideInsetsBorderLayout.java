 ...
 * <code>AFTER_LINE_ENDS</code>. These are equivalent to <code>PAGE_START</code>
 * , <code>PAGE_END</code>, <code>LINE_START</code> and <code>LINE_END</code>
 * respectively. For consistency with the relative positioning constants used by
 * other components, the latter constants are preferred.
 * <p>
 * Mixing both absolute and relative positioning constants can lead to
 * unpredictable results. If you use both types, the relative constants will
 * take precedence. For example, if you add components using both the
