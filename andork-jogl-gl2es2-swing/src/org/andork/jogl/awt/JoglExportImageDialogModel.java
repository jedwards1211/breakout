...
public class JoglExportImageDialogModel extends QSpec<JoglExportImageDialogModel> {
	...
	public static final Attribute<JoglExportImageDialogModel.ResolutionUnit> resolutionUnit = newAttribute(
			JoglExportImageDialogModel.ResolutionUnit.class, "resolutionUnit");
