...
public final class DirectDataBufferByte extends DataBuffer
{
	...
	public static class BufferedImageByte extends BufferedImage
	{
		...
		public BufferedImageByte( int customImageType , ColorModel cm , WritableRaster raster , Hashtable<?, ?> properties )
		{
		...
		/**
		 * @return one of the custom image-type values {@link BufferedImage#TYPE_INT_ARGB TYPE_INT_ARGB}, {@link BufferedImage#TYPE_INT_ARGB_PRE
		 *         TYPE_INT_ARGB_PRE}, {@link BufferedImage#TYPE_INT_RGB TYPE_INT_RGB} or {@link BufferedImage#TYPE_INT_BGR TYPE_INT_BGR}.
		 */
	...
	/**
	 * Creates a {@link BufferedImageByte} using a {@link DirectColorModel direct color model} in {@link ColorSpace#CS_sRGB sRGB color space}.<br>
	 * It uses a {@link DirectWritableRaster} utilizing {@link DirectDataBufferByte} storage.
	 * <p>
	 * Note that due to using the custom storage type {@link DirectDataBufferByte}, the resulting {@link BufferedImage}'s {@link BufferedImage#getType()
	 * image-type} is of {@link BufferedImage#TYPE_CUSTOM TYPE_CUSTOM}. We are not able to change this detail, since the AWT image implementation associates the
	 * {@link BufferedImage#getType() image-type} with a build-in storage-type. Use {@link BufferedImageByte#getCustomType()} to retrieve the custom image-type,
	 * which will return the <code>imageType</code> value passed here.
	 * </p>
	 * 
	 * @param width
	 * @param height
	 * @param imageType
	 *            one of {@link BufferedImage#TYPE_INT_ARGB TYPE_INT_ARGB}, {@link BufferedImage#TYPE_INT_ARGB_PRE TYPE_INT_ARGB_PRE},
	 ...
	 * @param properties
	 *            <code>Hashtable</code> of <code>String</code>/<code>Object</code> pairs. Used for {@link BufferedImage#getProperty(String)} etc.
	 * @return
	 */
	public static BufferedImageByte createBufferedImage( int width , int height , int imageType , Point location , Hashtable<?, ?> properties )
	{
	...
	/**
	 * Constructs an nio integer-based {@link DataBuffer} with a single bank and the specified size.
	 * 
	 * @param size
	...
	/**
	 * Constructs an nio integer-based {@link DataBuffer} with the specified number of banks, all of which are the specified size.
	 * 
	 * @param size
	...
	/**
	 * Constructs an nio integer-based {@link DataBuffer} with a single bank using the specified array.
	 * <p>
	 * Only the first <code>size</code> elements should be used by accessors of this {@link DataBuffer}. <code>dataArray</code> must be large enough to hold
