 ...
 * </ol>
 * <p>
 * In addition to sorting <code>AnnotatingTableRowSorter</code> provides the ability
...
public class AnnotatingTableRowSorter<M extends TableModel, A> extends AnnotatingRowSorter<M, Integer, A> {
     ...
     */
    public AnnotatingTableRowSorter() {
        this(null);
    }
     ...
     */
    public AnnotatingTableRowSorter(M model) {
        setModel(model);
    }

    /**
     * Sets the <code>TableModel</code> to use as the underlying model
     * for this <code>AnnotatingTableRowSorter</code>.  A value of <code>null</code>
