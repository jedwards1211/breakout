...
public class GridBagWizard {
	...
	public interface IConstrainer {
		 ...
		 * component's {@code gridheight} is
		 * {@link GridBagConstraints#REMAINDER REMAINDER}, the result is
		 * undefined.
		 * 
		 * @param comp
	...
	public class Constrainer implements IConstrainer {
		 ...
		 * 
		 * @see
		 * com.cybertrader.streamer.common.IConstrainer#leftOf(java.awt.Component
		 * )
		 */
		 ...
		 * 
		 * @see
		 * com.cybertrader.streamer.common.IConstrainer#rightOf(java.awt.Component
		 * )
		 */
		 ...
		 * 
		 * @see
		 * com.cybertrader.streamer.common.IConstrainer#sameWidth(java.awt.Component
		 * )
		 */
		 ...
		 * 
		 * @see
		 * com.cybertrader.streamer.common.IConstrainer#sameFill(java.awt.Component
		 * )
		 */
		 ...
		 * 
		 * @see
		 * com.cybertrader.streamer.common.IConstrainer#sameIpadx(java.awt.Component
		 * )
		 */
		 ...
		 * 
		 * @see
		 * com.cybertrader.streamer.common.IConstrainer#sameIpady(java.awt.Component
		 * )
		 */
		 ...
		 * 
		 * @see
		 * com.cybertrader.streamer.common.IConstrainer#sameIpad(java.awt.Component
		 * )
		 */
		 ...
		 * 
		 * @see
		 * com.cybertrader.streamer.common.IConstrainer#autoinsets(com.cybertrader
		 * .streamer.common.GridBagWizard.AutoInsets)
		 */
