...
public class UnitizedDoubleArrayParser<T extends UnitType<T>>
		implements Function<CharacterIterator, UnitizedDoubleArray<T>> {
	...
	public UnitizedDoubleArrayParser(ToDoubleFunction<CharacterIterator> doubleParser, CharPredicate isDelimiter,
