...
public class DoubleParser implements ToDoubleFunction<CharacterIterator> {
	...
	public DoubleParser() {
		this(createDefaultGroupingSeparator(), createDefaultDecimalSeparator(), createDefaultGroupSize(),
				createDefaultGroupSize());
	}

	public DoubleParser(CharSupplier groupingSeparator, CharSupplier decimalSeparator, IntSupplier groupSize,
			IntSupplier lastGroupSize) {
		super();
