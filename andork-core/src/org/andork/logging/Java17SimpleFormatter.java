...
/*
 * This file was adapted from the source of the SimpleFormatter in JDK 1.7 to port 1.7
 * functionality to earlier JREs.
 */
/*
...
public class Java17SimpleFormatter extends Formatter {
	 ...
	 * <p>
	 * The formatting can be customized by specifying the <a
	 * href="../Formatter.html#syntax">format string</a> in the <a
	 * href="#formatting"> {@code java.util.logging.SimpleFormatter.format}</a>
