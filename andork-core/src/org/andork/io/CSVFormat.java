...
public class CSVFormat {
	 ...
	 * @return a line of CSV containing the {@code fields} formatted according
	 *         to the settings of this {@link CSVFormat}.
	 */
	 ...
	 *            the line to parse.
	 * @param result
	 *            the {@link Collection} to place the fields parsed from
	 *            {@code line} into.
	 */
	...
	/**
	 * @return the quote character. The default is a double quote ("), but you
	 *         may change it.
	 */
	public char quote() {
		return quote;
	 ...
	 *             if {@code quote} is the null terminator or the same as
	 *             {@link #separator()}.
	 */
	...
	/**
	 * @return the separator character. The default is a comma, but you may
	 *         change it.
	 */
	 ...
	 * @return this {@link CSVFormat}, for chaining.
	 * @throws IllegalArgumentException
	 *             if {@code separator} is the null terminator or the same as
	 *             {@link #quote()}.
	 */
	...
	/**
	 * @return whether leading and trailing whitespace in fields will be
	 *         trimmed.
	 */
	 ...
	 *            if {@code true}, leading and trailing whitespace in fields
	 *            will be trimmed.
	 * @return this {@link CSVFormat}, for chaining.
	 */
