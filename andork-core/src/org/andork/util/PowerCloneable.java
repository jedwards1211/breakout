...
public interface PowerCloneable {
	...
	public static class Cloners {
		 ...
		 * @return a new array of the same length as {@code toClone} where each
		 *         element was the result of applying {@code subcloner} to the
		 *         corresponding element in {@code toClone}.
		 */
		 ...
		 *         {@code toClone.clone( Cloners::defaultClone )}. Otherwise,
		 *         returns {@code toClone}.
		 */
	...
	/**
	 * Clones this object. The returned object should not be {@code ==} to this
	 * object, but should {@code #equals(this)} .
	 *
	 * @param subcloner
	 *            a function that clones fields or other "elements" of this
	 *            object. Being able to choose the function allows you to
	 *            perform different styles of cloning, like deep or shallow
	 *            copying, or even a graph structure-preserving clone using an
