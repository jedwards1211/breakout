...
/**
 * A {@link Collection} that weakly references its elements; they will cease to belong to the collection once the garbage
 * collector determines that there are no more strong references to its elements. Iterators are guaranteed to return the
...
public class WeakOrderedCollection<E> extends AbstractCollection<E>
{
	...
	/**
	 * @param refs
	 *        the backing {@link List}. It should be empty, modifiable, and not be modified by anything by this {@code WeakOrderedCollection}.
	 */
