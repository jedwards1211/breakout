...
public class DoubleParserTest
{
	...
	public void test001( ) throws ParseException
	{
		...
		Assert.assertEquals( 1000.17 , new DoubleParser( ).applyAsDouble( new StringCharacterIterator( "   1,000.17   " ) ) , 0.0 );
		Assert.assertEquals( 12345678.17 , new DoubleParser( ).applyAsDouble( new StringCharacterIterator( "   12,345,678.17   " ) ) , 0.0 );
