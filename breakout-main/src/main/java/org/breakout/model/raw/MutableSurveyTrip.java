/**
 * Generated from {@code SurveyTrip.record.js} by java-record-generator on
 * 10/7/2025, 7:53:25 PM.
...
public final class MutableSurveyTrip {
	...
	private static boolean equals(Object a, Object b) {
		if (a instanceof Number || b instanceof Number || a instanceof String || b instanceof String) {
	...
	/**
	 * @return the station the LRUDs on each shot are associated with.
	 */
	public LrudAssociation getLrudAssociation() {
		return get(SurveyTrip.lrudAssociation);
	}
	 ...
	 * 
	 * @return this {@code SurveyTrip} if {@code cave} is unchanged, or a copy with
	 *         the new {@code cave}.
	 */
	 ...
	 * 
	 * @return this {@code SurveyTrip} if {@code name} is unchanged, or a copy with
	 *         the new {@code name}.
	 */
	 ...
	 * 
	 * @return this {@code SurveyTrip} if {@code date} is unchanged, or a copy with
	 *         the new {@code date}.
	 */
	 ...
	 * 
	 * @return this {@code SurveyTrip} if {@code attachedFiles} is unchanged, or a
	 *         copy with the new {@code attachedFiles}.
	 */
	 ...
	 * 
	 * @return this {@code SurveyTrip} if {@code surveyors} is unchanged, or a copy
	 *         with the new {@code surveyors}.
	 */
	 ...
	 * 
	 * @return this {@code SurveyTrip} if {@code distanceUnit} is unchanged, or a
	 *         copy with the new {@code distanceUnit}.
	 */
	 ...
	 * 
	 * @return this {@code SurveyTrip} if {@code angleUnit} is unchanged, or a copy
	 *         with the new {@code angleUnit}.
	 */
	 ...
	 *
	 * @param overrideFrontAzimuthUnit - the new value for default frontsight
	 *                                 azimuth unit
	 * 
	 * @return this {@code SurveyTrip} if {@code overrideFrontAzimuthUnit} is
	 *         unchanged, or a copy with the new {@code overrideFrontAzimuthUnit}.
	 */
	 ...
	 *
	 * @param overrideBackAzimuthUnit - the new value for default backsight azimuth
	 *                                unit
	 * 
	 * @return this {@code SurveyTrip} if {@code overrideBackAzimuthUnit} is
	 *         unchanged, or a copy with the new {@code overrideBackAzimuthUnit}.
	 */
	 ...
	 *
	 * @param overrideFrontInclinationUnit - the new value for default frontsight
	 *                                     inclination unit
	 * 
	 * @return this {@code SurveyTrip} if {@code overrideFrontInclinationUnit} is
	 *         unchanged, or a copy with the new
	 *         {@code overrideFrontInclinationUnit}.
	 */
	 ...
	 *
	 * @param overrideBackInclinationUnit - the new value for default backsight
	 *                                    inclination unit
	 * 
	 * @return this {@code SurveyTrip} if {@code overrideBackInclinationUnit} is
	 *         unchanged, or a copy with the new
	 *         {@code overrideBackInclinationUnit}.
	 */
	 ...
	 *
	 * @param backAzimuthsCorrected - the new value for whether backsight azimuths
	 *                              are corrected
	 * 
	 * @return this {@code SurveyTrip} if {@code backAzimuthsCorrected} is
	 *         unchanged, or a copy with the new {@code backAzimuthsCorrected}.
	 */
	 ...
	 *
	 * @param backInclinationsCorrected - the new value for whether backsight
	 *                                  inclinations are corrected
	 * 
	 * @return this {@code SurveyTrip} if {@code backInclinationsCorrected} is
	 *         unchanged, or a copy with the new {@code backInclinationsCorrected}.
	 */
	 ...
	 * 
	 * @return this {@code SurveyTrip} if {@code declination} is unchanged, or a
	 *         copy with the new {@code declination}.
	 */
	 ...
	 * 
	 * @return this {@code SurveyTrip} if {@code distanceCorrection} is unchanged,
	 *         or a copy with the new {@code distanceCorrection}.
	 */
	 ...
	 *
	 * @param frontAzimuthCorrection - the new value for correction for frontsight
	 *                               azimuths
	 * 
	 * @return this {@code SurveyTrip} if {@code frontAzimuthCorrection} is
	 *         unchanged, or a copy with the new {@code frontAzimuthCorrection}.
	 */
	 ...
	 *
	 * @param frontInclinationCorrection - the new value for correction for
	 *                                   frontsight inclinations
	 * 
	 * @return this {@code SurveyTrip} if {@code frontInclinationCorrection} is
	 *         unchanged, or a copy with the new {@code frontInclinationCorrection}.
	 */
	 ...
	 *
	 * @param backAzimuthCorrection - the new value for correction for backsight
	 *                              azimuths
	 * 
	 * @return this {@code SurveyTrip} if {@code backAzimuthCorrection} is
	 *         unchanged, or a copy with the new {@code backAzimuthCorrection}.
	 */
	 ...
	 *
	 * @param backInclinationCorrection - the new value for correction for backsight
	 *                                  inclinations
	 * 
	 * @return this {@code SurveyTrip} if {@code backInclinationCorrection} is
	 *         unchanged, or a copy with the new {@code backInclinationCorrection}.
	 */
	...
	/**
	 * Sets the station the LRUDs on each shot are associated with.
	 *
	 * @param lrudAssociation - the new value for the station the LRUDs on each shot
	 *                        are associated with
	 * 
	 * @return this {@code SurveyTrip} if {@code lrudAssociation} is unchanged, or a
	 *         copy with the new {@code lrudAssociation}.
	 */
	public MutableSurveyTrip setLrudAssociation(LrudAssociation lrudAssociation) {
		return set(SurveyTrip.lrudAssociation, lrudAssociation);
	}

	/**
	 * Sets the geodetic datum for fixed station locations.
	 *
	 * @param datum - the new value for the geodetic datum for fixed station
	 *              locations
	 * 
	 * @return this {@code SurveyTrip} if {@code datum} is unchanged, or a copy with
	 *         the new {@code datum}.
	 */
	 ...
	 *
	 * @param ellipsoid - the new value for the reference ellipsoid for fixed
	 *                  station locations
	 * 
	 * @return this {@code SurveyTrip} if {@code ellipsoid} is unchanged, or a copy
	 *         with the new {@code ellipsoid}.
	 */
	 ...
	 * 
	 * @return this {@code SurveyTrip} if {@code utmZone} is unchanged, or a copy
	 *         with the new {@code utmZone}.
	 */
	 ...
	 * Updates cave name.
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code cave} and returns the new value for {@code cave}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code cave} is unchanged, or a
	 *         copy with the updated {@code cave}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code name} and returns the new value for {@code name}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code name} is unchanged, or a
	 *         copy with the updated {@code name}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code date} and returns the new value for {@code date}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code date} is unchanged, or a
	 *         copy with the updated {@code date}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code attachedFiles} and returns the new value for
	 *                {@code attachedFiles}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code attachedFiles} is unchanged,
	 *         or a copy with the updated {@code attachedFiles}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code surveyors} and returns the new value for
	 *                {@code surveyors}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code surveyors} is unchanged, or
	 *         a copy with the updated {@code surveyors}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code distanceUnit} and returns the new value for
	 *                {@code distanceUnit}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code distanceUnit} is unchanged,
	 *         or a copy with the updated {@code distanceUnit}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code angleUnit} and returns the new value for
	 *                {@code angleUnit}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code angleUnit} is unchanged, or
	 *         a copy with the updated {@code angleUnit}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code overrideFrontAzimuthUnit} and returns the new value for
	 *                {@code overrideFrontAzimuthUnit}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code overrideFrontAzimuthUnit} is
	 *         unchanged, or a copy with the updated
	 *         {@code overrideFrontAzimuthUnit}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code overrideBackAzimuthUnit} and returns the new value for
	 *                {@code overrideBackAzimuthUnit}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code overrideBackAzimuthUnit} is
	 *         unchanged, or a copy with the updated
	 *         {@code overrideBackAzimuthUnit}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code overrideFrontInclinationUnit} and returns the new value
	 *                for {@code overrideFrontInclinationUnit}.
	 * 
	 * @return this {@code MutableSurveyTrip} if
	 *         {@code overrideFrontInclinationUnit} is unchanged, or a copy with the
	 *         updated {@code overrideFrontInclinationUnit}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code overrideBackInclinationUnit} and returns the new value
	 *                for {@code overrideBackInclinationUnit}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code overrideBackInclinationUnit}
	 *         is unchanged, or a copy with the updated
	 *         {@code overrideBackInclinationUnit}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code backAzimuthsCorrected} and returns the new value for
	 *                {@code backAzimuthsCorrected}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code backAzimuthsCorrected} is
	 *         unchanged, or a copy with the updated {@code backAzimuthsCorrected}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code backInclinationsCorrected} and returns the new value
	 *                for {@code backInclinationsCorrected}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code backInclinationsCorrected}
	 *         is unchanged, or a copy with the updated
	 *         {@code backInclinationsCorrected}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code declination} and returns the new value for
	 *                {@code declination}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code declination} is unchanged,
	 *         or a copy with the updated {@code declination}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code distanceCorrection} and returns the new value for
	 *                {@code distanceCorrection}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code distanceCorrection} is
	 *         unchanged, or a copy with the updated {@code distanceCorrection}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code frontAzimuthCorrection} and returns the new value for
	 *                {@code frontAzimuthCorrection}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code frontAzimuthCorrection} is
	 *         unchanged, or a copy with the updated {@code frontAzimuthCorrection}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code frontInclinationCorrection} and returns the new value
	 *                for {@code frontInclinationCorrection}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code frontInclinationCorrection}
	 *         is unchanged, or a copy with the updated
	 *         {@code frontInclinationCorrection}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code backAzimuthCorrection} and returns the new value for
	 *                {@code backAzimuthCorrection}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code backAzimuthCorrection} is
	 *         unchanged, or a copy with the updated {@code backAzimuthCorrection}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code backInclinationCorrection} and returns the new value
	 *                for {@code backInclinationCorrection}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code backInclinationCorrection}
	 *         is unchanged, or a copy with the updated
	 *         {@code backInclinationCorrection}.
	 */
	...
	/**
	 * Updates the station the LRUDs on each shot are associated with.
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code lrudAssociation} and returns the new value for
	 *                {@code lrudAssociation}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code lrudAssociation} is
	 *         unchanged, or a copy with the updated {@code lrudAssociation}.
	 */
	public MutableSurveyTrip updateLrudAssociation(Function<LrudAssociation, LrudAssociation> updater) {
		return update(SurveyTrip.lrudAssociation, updater);
	}
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code datum} and returns the new value for {@code datum}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code datum} is unchanged, or a
	 *         copy with the updated {@code datum}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code ellipsoid} and returns the new value for
	 *                {@code ellipsoid}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code ellipsoid} is unchanged, or
	 *         a copy with the updated {@code ellipsoid}.
	 */
	 ...
	 *
	 * @param updater - {@code Function} that takes the current value of
	 *                {@code utmZone} and returns the new value for {@code utmZone}.
	 * 
	 * @return this {@code MutableSurveyTrip} if {@code utmZone} is unchanged, or a
	 *         copy with the updated {@code utmZone}.
	 */
