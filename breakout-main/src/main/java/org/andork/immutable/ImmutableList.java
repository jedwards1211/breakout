...
public interface ImmutableList<E> extends Iterable<E> {
	 ...
	 */
	default ImmutableList<E> add(E e) {
		return toMutable().add(e).toImmutable();
	}
	 ...
	 */
	default ImmutableList<E> remove(Object o) {
		return toMutable().remove(o).toImmutable();
	}
	 ...
	 * @see #add(Object)
	 */
	default ImmutableList<E> addAll(Collection<? extends E> c) {
		return toMutable().addAll(c).toImmutable();
	}
	 ...
	 */
	default ImmutableList<E> addAll(int index, Collection<? extends E> c) {
		return toMutable().addAll(index, c).toImmutable();
	}
	 ...
	 * @see #contains(Object)
	 */
	default ImmutableList<E> removeAll(Collection<?> c) {
		return toMutable().removeAll(c).toImmutable();
	}
	 ...
	 * @see #contains(Object)
	 */
	default ImmutableList<E> retainAll(Collection<?> c) {
		return toMutable().retainAll(c).toImmutable();
	}
	 ...
	 * @since 1.8
	 */
	default ImmutableList<E> replaceAll(UnaryOperator<E> operator) {
		return toMutable().replaceAll(operator).toImmutable();
	}
	 ...
	 * @since 1.8
	 */
	default ImmutableList<E> sort(Comparator<? super E> c) {
		return toMutable().sort(c).toImmutable();
	}
	 ...
	 *                                   (<tt>index &lt; 0 || index &gt;= size()</tt>)
	 */
	default ImmutableList<E> set(int index, E element) {
		return toMutable().set(index, element).toImmutable();
	}
	 ...
	 *                                   (<tt>index &lt; 0 || index &gt; size()</tt>)
	 */
	default ImmutableList<E> add(int index, E element) {
		return toMutable().add(index, element).toImmutable();
	}
	 ...
	 *                                       (<tt>index &lt; 0 || index &gt;= size()</tt>)
	 */
	default ImmutableList<E> remove(int index) {
		return toMutable().remove(index).toImmutable();
	}
	...
	MutableList<E> toMutable();

	default ImmutableList<E> withMutations(Consumer<MutableList<E>> mutator) {
		MutableList<E> mutable = toMutable();
