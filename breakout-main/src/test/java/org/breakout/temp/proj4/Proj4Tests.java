...
public class Proj4Tests {
	...
	public void testParser() {
		...
		// CoordinateReferenceSystem merc = factory.createFromParameters(null,
		// "+proj=merc +lat_ts=56.5 +ellps=GRS80");
		// CoordinateReferenceSystem utm32 = factory.createFromParameters(null,
		// "+proj=utm +zone=32");
		// CoordinateReferenceSystem utm14 = factory.createFromParameters(null,
		// "+proj=utm +zone=14");
		// CoordinateReferenceSystem utm15 = factory.createFromParameters(null,
		// "+proj=utm +zone=15");
		...
		// System.out.println(to);
		//
		// CoordinateReferenceSystem totesGebirge = factory.createFromParameters(null,
		// "+proj=tmerc +lat_0=0 +lon_0=13d20 +k=1 +x_0=0 +y_0=-5200000 +ellps=bessel
		// +towgs84=577.326,90.129,463.919,5.137,1.474,5.297,2.4232");
		// xform = new BasicCoordinateTransform(totesGebirge.createGeographic(),
		// totesGebirge);
