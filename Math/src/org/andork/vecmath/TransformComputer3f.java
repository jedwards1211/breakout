...
public class TransformComputer3f
{
	 ...
	 * 
	 * @see #shear(Point3d, Vector3d, Vector3d, Vector3d, Point3d, Vector3d, Vector3d, Vector3d, Matrix4f)
	 */
	 ...
	 *            the new z axis.
	 * @param result
	 *            the Matrix4f to set such that (ignoring floating-point inaccuracy):
	 *            <ul>
	 ...
	 *             if <code>newX</code>, <code>newY</code>, or <code>newZ</code> is zero
	 */
	public Matrix4f shear( Point3f oldOrigin , Vector3f oldX , Vector3f oldY , Vector3f oldZ , Point3f newOrigin , Vector3f newX , Vector3f newY , Vector3f newZ , Matrix4f result )
	{
	 ...
	 * 
	 * @see #orient(Point3f, Vector3f, Vector3f, Point3f, Vector3f, Vector3f, Matrix4f)
	 */
	 ...
	 *             </ul>
	 */
	public Matrix4f orient( Point3f oldOrigin , Vector3f oldX , Vector3f oldY , Point3f newOrigin , Vector3f newX , Vector3f newY , Matrix4f result )
	{
